// entropy-field-static.glsl
// Frozen variant of entropy-field — no animation (iTime unused). A still
// entropy texture: haze, a fixed sampling lattice, baseline glow, vignette.
// For zero-motion / minimal-distraction use.
